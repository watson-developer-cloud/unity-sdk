...
namespace IBM.Watson.Services.v1
{
    ...
    {
        private const string SERVICE_ID = "GeolocationV1"; 
        ...
        {
            RESTConnector connector = RESTConnector.GetConnector( SERVICE_ID, "/arcgis/rest/services/World/GeocodeServer/find" );
            if ( connector == null )
                return false;
            ...
            req.Parameters["f"] = "pjson";
            req.Parameters["text"] = location;
