...
namespace FullSerializer.Speedup {
    public class IBM_Watson_DataModels_SpeechModel_DirectConverter : fsDirectConverter<IBM.Watson.DataModels.SpeechModel> {
        protected override fsResult DoSerialize(IBM.Watson.DataModels.SpeechModel model, Dictionary<string, fsData> serialized) {
        ...
        protected override fsResult DoDeserialize(Dictionary<string, fsData> data, ref IBM.Watson.DataModels.SpeechModel model) {
            var result = fsResult.Success;
        ...
        public override object CreateInstance(fsData data, Type storageType) {
            return new IBM.Watson.DataModels.SpeechModel();
        }
    }
}
