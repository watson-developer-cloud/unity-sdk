...
namespace IBM.Watson.Widgets.Question
{
    ...
    public class CubeAnimationManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            m_initialPositionMainCamera = UnityEngine.Camera.main.transform.position;
        ...
        {
            if (isRotating && (currentAnimationState == CubeAnimationState.IdleOnScene || currentAnimationState == CubeAnimationState.Folding))
        ...
        private void AnimateUnFold(System.Action<System.Object> callBackOnComplete = null, System.Object paramOnComplete = null)
        {
            ...
            //Rotate to camera 
            animationRotationCube = LeanTween.rotateLocal(gameObject, 
                UnityEngine.Camera.main.transform.rotation.eulerAngles - 
                new Vector3(0.0f, 90.0f, 0.0f), timeForFoldingUnfolding).setEase(easeForUnfolding).setOnComplete(
                () =>
                {
            ...
            //Move object close to camera
            animationPositionCube = LeanTween.move(gameObject, m_initialPositionMainCamera 
                + distanceFromCameraInZAfterUnfolding * UnityEngine.Camera.main.transform.forward 
                + positionCubeOffsetUnfold, timeForFoldingUnfolding).setEase(easeForUnfolding);
