...
{
  public class TestPersonalityInsightsV2 : UnitTest
  {
    ...
    private void OnGetProfileText(Profile profile, string data)
    {
      ...
      if (profile != null)
      {
        if (!string.IsNullOrEmpty(profile.id))
          Log.Debug("TestPersonalityInsightsV2", "id: {0}", profile.id);
        if (!string.IsNullOrEmpty(profile.source))
          Log.Debug("TestPersonalityInsightsV2", "source: {0}", profile.source);
        ...
        if (!string.IsNullOrEmpty(profile.word_count))
          Log.Debug("TestPersonalityInsightsV2", "word_count: {0}", profile.word_count);
        if (!string.IsNullOrEmpty(profile.word_count_message))
          Log.Debug("TestPersonalityInsightsV2", "word_count_message: {0}", profile.word_count_message);
    ...
    private void LogTraitTree(TraitTreeNode traitTreeNode)
    {
      if (!string.IsNullOrEmpty(traitTreeNode.id))
        Log.Debug("TestPersonalityInsightsV2", "id: {0}", traitTreeNode.id);
      if (!string.IsNullOrEmpty(traitTreeNode.name))
        Log.Debug("TestPersonalityInsightsV2", "name: {0}", traitTreeNode.name);
      if (!string.IsNullOrEmpty(traitTreeNode.category))
        Log.Debug("TestPersonalityInsightsV2", "category: {0}", traitTreeNode.category);
      if (!string.IsNullOrEmpty(traitTreeNode.percentage))
        Log.Debug("TestPersonalityInsightsV2", "percentage: {0}", traitTreeNode.percentage);
      if (!string.IsNullOrEmpty(traitTreeNode.sampling_error))
        Log.Debug("TestPersonalityInsightsV2", "sampling_error: {0}", traitTreeNode.sampling_error);
      if (!string.IsNullOrEmpty(traitTreeNode.raw_score))
        Log.Debug("TestPersonalityInsightsV2", "raw_score: {0}", traitTreeNode.raw_score);
