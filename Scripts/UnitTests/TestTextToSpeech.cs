...
namespace IBM.Watson.DeveloperCloud.UnitTests
{
    ...
    {
        private TextToSpeech m_TextToSpeech = new TextToSpeech(new Credentials());
        ...
        private void OnSpeechGET(AudioClip clip, string data)
        {
        ...
        private void OnSpeechPOST(AudioClip clip, string data)
        {
