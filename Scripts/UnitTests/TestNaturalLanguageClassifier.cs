...
//    {
//        NaturalLanguageClassifier m_NaturalLanguageClassifier = new NaturalLanguageClassifier(new Credentials());
...
//        private void OnTrainClassifier(Classifier classifier, string customData)
//        {
