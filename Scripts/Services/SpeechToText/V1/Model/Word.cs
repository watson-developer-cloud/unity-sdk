...
namespace IBM.Watson.SpeechToText.V1.Model
{
    ...
    public class Word
    {
        ...
        /// generated by the service if none is provided for the word; the service adds this pronunciation when it
        ...
        /// times in one corpus and seven times in another, its count is `12`. If you add a custom word to a model
        /// before it is added by any corpora, the count begins at `1`; if the word is added from a corpus first and
        /// later modified, the count reflects only the number of times it is found in corpora.
        /// </summary>
        [JsonProperty("count", NullValueHandling = NullValueHandling.Ignore)]
        public long? Count { get; set; }
        /// <summary>
        /// An array of sources that describes how the word was added to the custom model's words resource. For OOV
        /// words added from a corpus, includes the name of the corpus; if the word was added by multiple corpora, the
        /// names of all corpora are listed. If the word was modified or added by the user directly, the field includes
        /// the string `user`.
        /// </summary>
