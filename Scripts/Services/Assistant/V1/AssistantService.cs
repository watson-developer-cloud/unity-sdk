...
namespace IBM.Watson.Assistant.V1
{
    public partial class AssistantService : BaseService
    {
        ...
        public bool Message(Callback<MessageResponse> callback, string workspaceId, JObject input = null, List<RuntimeIntent> intents = null, List<RuntimeEntity> entities = null, bool? alternateIntents = null, JObject context = null, JObject output = null, bool? nodesVisitedDetails = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v1/workspaces/{0}/message", workspaceId), serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool ListWorkspaces(Callback<WorkspaceCollection> callback, long? pageLimit = null, string sort = null, string cursor = null, bool? includeAudit = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, "/v1/workspaces", serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool GetWorkspace(Callback<Workspace> callback, string workspaceId, bool? export = null, bool? includeAudit = null, string sort = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v1/workspaces/{0}", workspaceId), serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool ListIntents(Callback<IntentCollection> callback, string workspaceId, bool? export = null, long? pageLimit = null, string sort = null, string cursor = null, bool? includeAudit = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v1/workspaces/{0}/intents", workspaceId), serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool GetIntent(Callback<Intent> callback, string workspaceId, string intent, bool? export = null, bool? includeAudit = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v1/workspaces/{0}/intents/{1}", workspaceId, intent), serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool ListExamples(Callback<ExampleCollection> callback, string workspaceId, string intent, long? pageLimit = null, string sort = null, string cursor = null, bool? includeAudit = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v1/workspaces/{0}/intents/{1}/examples", workspaceId, intent), serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool GetExample(Callback<Example> callback, string workspaceId, string intent, string text, bool? includeAudit = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v1/workspaces/{0}/intents/{1}/examples/{2}", workspaceId, intent, text), serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool ListCounterexamples(Callback<CounterexampleCollection> callback, string workspaceId, long? pageLimit = null, string sort = null, string cursor = null, bool? includeAudit = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v1/workspaces/{0}/counterexamples", workspaceId), serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool GetCounterexample(Callback<Counterexample> callback, string workspaceId, string text, bool? includeAudit = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v1/workspaces/{0}/counterexamples/{1}", workspaceId, text), serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool ListEntities(Callback<EntityCollection> callback, string workspaceId, bool? export = null, long? pageLimit = null, string sort = null, string cursor = null, bool? includeAudit = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v1/workspaces/{0}/entities", workspaceId), serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool GetEntity(Callback<Entity> callback, string workspaceId, string entity, bool? export = null, bool? includeAudit = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v1/workspaces/{0}/entities/{1}", workspaceId, entity), serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool ListMentions(Callback<EntityMentionCollection> callback, string workspaceId, string entity, bool? export = null, bool? includeAudit = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v1/workspaces/{0}/entities/{1}/mentions", workspaceId, entity), serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool ListValues(Callback<ValueCollection> callback, string workspaceId, string entity, bool? export = null, long? pageLimit = null, string sort = null, string cursor = null, bool? includeAudit = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v1/workspaces/{0}/entities/{1}/values", workspaceId, entity), serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool GetValue(Callback<Value> callback, string workspaceId, string entity, string value, bool? export = null, bool? includeAudit = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v1/workspaces/{0}/entities/{1}/values/{2}", workspaceId, entity, value), serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool ListSynonyms(Callback<SynonymCollection> callback, string workspaceId, string entity, string value, long? pageLimit = null, string sort = null, string cursor = null, bool? includeAudit = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v1/workspaces/{0}/entities/{1}/values/{2}/synonyms", workspaceId, entity, value), serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool GetSynonym(Callback<Synonym> callback, string workspaceId, string entity, string value, string synonym, bool? includeAudit = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v1/workspaces/{0}/entities/{1}/values/{2}/synonyms/{3}", workspaceId, entity, value, synonym), serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool ListDialogNodes(Callback<DialogNodeCollection> callback, string workspaceId, long? pageLimit = null, string sort = null, string cursor = null, bool? includeAudit = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v1/workspaces/{0}/dialog_nodes", workspaceId), serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool GetDialogNode(Callback<DialogNode> callback, string workspaceId, string dialogNode, bool? includeAudit = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v1/workspaces/{0}/dialog_nodes/{1}", workspaceId, dialogNode), serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool ListLogs(Callback<LogCollection> callback, string workspaceId, string sort = null, string filter = null, long? pageLimit = null, string cursor = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v1/workspaces/{0}/logs", workspaceId), serviceUrl);
            if (connector == null)
            {
                return false;
            }
