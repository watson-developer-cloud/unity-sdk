...
namespace IBM.Watson.Assistant.V1.Model
{
    ...
    public class DialogRuntimeResponseGeneric
    {
        ...
        /// **Note:** The **suggestion** response type is part of the disambiguation feature, which is only available
        /// for Premium users.
        /// Constants for possible values can be found using DialogRuntimeResponseGeneric.ResponseTypeValue
        /// </summary>
        [JsonProperty("response_type", NullValueHandling = NullValueHandling.Ignore)]
        public string ResponseType { get; set; }
        /// <summary>
        /// The preferred type of control to display.
        /// Constants for possible values can be found using DialogRuntimeResponseGeneric.PreferenceValue
        /// </summary>
