...
namespace IBM.Watson.Assistant.V1.Model
{
    ...
    public class UpdateDialogNode
    {
        ...
        /// <summary>
        /// How the dialog node is processed.
        /// Constants for possible values can be found using UpdateDialogNode.NodeTypeValue
        /// </summary>
        [JsonProperty("type", NullValueHandling = NullValueHandling.Ignore)]
        public string NodeType { get; set; }
        /// <summary>
        /// How an `event_handler` node is processed.
        /// Constants for possible values can be found using UpdateDialogNode.EventNameValue
        /// </summary>
        [JsonProperty("event_name", NullValueHandling = NullValueHandling.Ignore)]
        public string EventName { get; set; }
        /// <summary>
        /// Whether this top-level dialog node can be digressed into.
        /// Constants for possible values can be found using UpdateDialogNode.DigressInValue
        /// </summary>
        [JsonProperty("digress_in", NullValueHandling = NullValueHandling.Ignore)]
        public string DigressIn { get; set; }
        /// <summary>
        /// Whether this dialog node can be returned to after a digression.
        /// Constants for possible values can be found using UpdateDialogNode.DigressOutValue
        /// </summary>
        [JsonProperty("digress_out", NullValueHandling = NullValueHandling.Ignore)]
        public string DigressOut { get; set; }
        /// <summary>
        /// Whether the user can digress to top-level nodes while filling out slots.
        /// Constants for possible values can be found using UpdateDialogNode.DigressOutSlotsValue
        /// </summary>
