...
namespace IBM.Watson.VisualRecognition.V3
{
    public partial class VisualRecognitionService : BaseService
    {
        ...
        {
            Log.Warning("Visual Recognition Deprecation Warning:", "On 1 December 2021, Visual Recognition will no longer be available. For more information, see https://github.com/watson-developer-cloud/python-sdk/tree/master#visual-recognition-deprecation.");
