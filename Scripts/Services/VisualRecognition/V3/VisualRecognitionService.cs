...
namespace IBM.Watson.VisualRecognition.V3
{
    public partial class VisualRecognitionService : BaseService
    {
        ...
        public bool Classify(Callback<ClassifiedImages> callback, System.IO.MemoryStream imagesFile = null, string imagesFilename = null, string imagesFileContentType = null, string url = null, float? threshold = null, List<string> owners = null, List<string> classifierIds = null, string acceptLanguage = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, "/v3/classify", serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool DetectFaces(Callback<DetectedFaces> callback, System.IO.MemoryStream imagesFile = null, string imagesFilename = null, string imagesFileContentType = null, string url = null, string acceptLanguage = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, "/v3/detect_faces", serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool CreateClassifier(Callback<Classifier> callback, string name, Dictionary<string, System.IO.MemoryStream> positiveExamples, System.IO.MemoryStream negativeExamples = null, string negativeExamplesFilename = null)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, "/v3/classifiers", serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool GetClassifier(Callback<Classifier> callback, string classifierId)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v3/classifiers/{0}", classifierId), serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool GetCoreMlModel(Callback<byte[]> callback, string classifierId)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, string.Format("/v3/classifiers/{0}/core_ml_model", classifierId), serviceUrl);
            if (connector == null)
            {
                return false;
            }
        ...
        public bool DeleteUserData(Callback<object> callback, string customerId)
        {
            ...
            RESTConnector connector = RESTConnector.GetConnector(Authenticator, "/v3/user_data", serviceUrl);
            if (connector == null)
            {
                return false;
            }
