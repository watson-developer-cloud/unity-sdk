...
namespace IBM.Watson.DeveloperCloud.Services.LanguageTranslator.v1
{
    ...
    public class LanguageTranslator : IWatsonService
    {
        ...
        /// </summary>
        /// <param name="languages"></param>
        public delegate void IdentifyCallback(IdentifiedLanguages languages, string customData);
        /// <summary>
        ...
        private void OnIdentifyResponse(RESTConnector.Request req, RESTConnector.Response resp)
        {
            ...
            IdentifiedLanguages identifiedLanguages = new IdentifiedLanguages();
            fsData data = null;
            ...
            if (resp.Success)
            {
                ...
                {
                    Log.Error("Natural Language Classifier", "IdentifyLanguage Exception: {0}", e.ToString());
                    resp.Success = false;
                }
                ...
                if (((IdentifyReq)req).Callback != null)
                    ((IdentifyReq)req).Callback(resp.Success ? identifiedLanguages : null, (!string.IsNullOrEmpty(customData) ? customData : data.ToString()));
            }
        }
        #endregion
