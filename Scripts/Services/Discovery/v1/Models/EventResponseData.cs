...
namespace IBM.Watson.DeveloperCloud.Services.Discovery.v1
{
    ...
    /// </summary>
    [fsObject(Converter = typeof(EventResponseDataConverter))]
    ...
    public class EventResponseDataConverter : fsConverter
    {
        private static fsSerializer sm_Serializer = new fsSerializer();

        public override bool CanProcess(Type type)
        {
            return type == typeof(EventResponseData);
        }
        ...
        {
            EventResponseData eventResponseData = (EventResponseData)instance;
            serialized = null;
            ...
            if (eventResponseData.EnvironmentId != null)
            {
                sm_Serializer.TrySerialize(eventResponseData.EnvironmentId, out tempData);
                serialization.Add("environment_id", tempData);
            }

            if (eventResponseData.SessionToken != null)
            {
                sm_Serializer.TrySerialize(eventResponseData.SessionToken, out tempData);
                serialization.Add("session_token", tempData);
            }

            if (eventResponseData.ClientTimestamp != null)
            {
                sm_Serializer.TrySerialize(eventResponseData.ClientTimestamp, out tempData);
                serialization.Add("client_timestamp", tempData);
            }

            if (eventResponseData.DisplayRank != null)
            {
                sm_Serializer.TrySerialize(eventResponseData.DisplayRank, out tempData);
                serialization.Add("display_rank", tempData);
            }

            if (eventResponseData.CollectionId != null)
            {
                sm_Serializer.TrySerialize(eventResponseData.CollectionId, out tempData);
                serialization.Add("collection_id", tempData);
            }

            if (eventResponseData.DocumentId != null)
            {
                sm_Serializer.TrySerialize(eventResponseData.DocumentId, out tempData);
                serialization.Add("document_id", tempData);
            }

            if (eventResponseData.QueryId != null)
            {
                sm_Serializer.TrySerialize(eventResponseData.QueryId, out tempData);
