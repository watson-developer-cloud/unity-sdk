...
namespace IBM.Watson.DeveloperCloud.Widgets
{
    ...
    public class LanguageTranslatorWidget : Widget
    {
        ...
        private class TranslateRequest
        {
            ...
            private void OnIdentified(IdentifiedLanguages languages, string customData)
            {
                if (languages != null)
                {
                    string language = languages.languages[0].language;
            ...
            private void OnGetTranslation(Translations translations, string data)
            {
