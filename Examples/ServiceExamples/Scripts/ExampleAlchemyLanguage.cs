...
public class ExampleAlchemyLanguage : MonoBehaviour
{
    ...
    private string unitySDK_release_html;
    private string watson_beats_jeopardy_html;
    private string microformats_html;
    private string ycombinator_html;

    bool _getAuthorsURLTested = false;
    bool _getAuthorsHTMLTested = false;

    bool _getRankedConceptsHTMLTested = false;
    bool _getRankedConceptsURLTested = false;
    bool _getRankedConceptsTextTested = false;

    bool _getDatesHTMLTested = false;
    bool _getDatesURLTested = false;
    bool _getDatesTextTested = false;

    bool _getEmotionHTMLTested = false;
    bool _getEmotionURLTested = false;
    bool _getEmotionTextTested = false;

    bool _getEntityExtractionHTMLTested = false;
    bool _getEntityExtractionURLTested = false;
    bool _getEntityExtractionTextTested = false;

    bool _detectFeedsURLTested = false;
    //bool _detectFeedsHTMLTested = false;

    bool _getKeywordExtractionHTMLTested = false;
    bool _getKeywordExtractionURLTested = false;
    bool _getKeywordExtractionTextTested = false;

    bool _getLanguageHTMLTested = false;
    bool _getLanguageURLTested = false;
    bool _getLanguageTextTested = false;

    bool _getMicroformatURLTested = false;
    //bool _getMicroformatHTMLTested = false;

    bool _getPubDateURLTested = false;
    bool _getPubDateHTMLTested = false;

    bool _getRelationsHTMLTested = false;
    bool _getRelationsURLTested = false;
    bool _getRelationsTextTested = false;

    bool _getTextSentimentHTMLTested = false;
    bool _getTextSentimentURLTested = false;
    bool _getTextSentimentTextTested = false;

    bool _getTargetedSentimentHTMLTested = false;
    bool _getTargetedSentimentURLTested = false;
    bool _getTargetedSentimentTextTested = false;

    bool _getRankedTaxonomyHTMLTested = false;
    bool _getRankedTaxonomyURLTested = false;
    bool _getRankedTaxonomyTextTested = false;

    bool _getTextHTMLTested = false;
    bool _getTextURLTested = false;

    bool _getRawTextHTMLTested = false;
    bool _getRawTextURLTested = false;

    bool _getTitleHTMLTested = false;
    bool _getTitleURLTested = false;

    bool _getCombinedDataHTMLTested = false;
    bool _getCombinedDataURLTested = false;
    bool _getCombinedDataTextTested = false;
    ...
    void Start()
    {
        ...
        unitySDK_release_html = Application.dataPath + "/Watson/Examples/ServiceExamples/TestData/unitySDK_release.html";
        watson_beats_jeopardy_html = Application.dataPath + "/Watson/Examples/ServiceExamples/TestData/watson_beats_jeopardy.html";
        microformats_html = Application.dataPath + "/Watson/Examples/ServiceExamples/TestData/microformats.html";
        ycombinator_html = Application.dataPath + "/Watson/Examples/ServiceExamples/TestData/ycombinator_news.html";
    ...
    private IEnumerator Examples()
    {
        ...
        if (!_alchemyAPI.GetAuthors(OnGetAuthorsHtml, watson_beats_jeopardy_html))
        ...
        if (!_alchemyAPI.GetRankedConcepts(OnGetConceptsHtml, watson_beats_jeopardy_html))
        ...
        //Get Date HTML POST
        if (!_alchemyAPI.GetDates(OnGetDatesHtml, watson_beats_jeopardy_html))
        ...
        if (!_alchemyAPI.GetEmotions(OnGetEmotionsHtml, watson_beats_jeopardy_html, true))
        ...
        if (!_alchemyAPI.ExtractEntities(OnExtractEntitiesHtml, watson_beats_jeopardy_html))
        ...
        if (!_alchemyAPI.ExtractKeywords(OnExtractKeywordsHtml, watson_beats_jeopardy_html))
        ...
        if (!_alchemyAPI.GetLanguages(OnGetLanguagesHtml, watson_beats_jeopardy_html))
        ...
        if (!_alchemyAPI.GetPublicationDate(OnGetPublicationDateHtml, watson_beats_jeopardy_html))
        ...
        if (!_alchemyAPI.GetRelations(OnGetRelationsHtml, watson_beats_jeopardy_html))
        ...
        if (!_alchemyAPI.GetTextSentiment(OnGetTextSentimentHtml, watson_beats_jeopardy_html))
        ...
        if (!_alchemyAPI.GetTargetedSentiment(OnGetTargetedSentimentHtml, watson_beats_jeopardy_html, "Jeopardy|Jennings|Watson"))
        ...
        if (!_alchemyAPI.GetRankedTaxonomy(OnGetRankedTaxonomyHtml, watson_beats_jeopardy_html))
            Log.Debug("ExampleAlchemyLanguage", "Failed to get ranked taxonomy by HTML POST");
        while (!_getRankedTaxonomyHTMLTested)
            yield return null;

        //Get Text HTML POST
        if (!_alchemyAPI.GetText(OnGetTextHtml, watson_beats_jeopardy_html))
        ...
        if (!_alchemyAPI.GetRawText(OnGetRawTextHtml, watson_beats_jeopardy_html))
        ...
        //Get Title HTML POST
        if (!_alchemyAPI.GetTitle(OnGetTitleHtml, watson_beats_jeopardy_html))
        ...
        if (!_alchemyAPI.GetCombinedData(OnGetCombinedDataHtml, watson_beats_jeopardy_html, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true))
